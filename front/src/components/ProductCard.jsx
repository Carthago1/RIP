...
export const ProductCard = (props) => {
    ...
    return (
        <div className='p-8 rounded-xl bg-gray-300 min-w-[400px] max-w-[50vh] flex flex-col cursor-pointer my-8'>
            <img src={props.photo} alt={props.name} onClick={handleNavigate} />
            <p>
